...
"""
New function to finetune LLAMA on the UD HPC resources.

Things I need to figure out:
    - Can I load it through huggingface transformers?
    - Will it work with pytorch lightning?
    
More generally speaking though, we want to finetune a variety of models and test the brainscores and ethics performance of them.
Right now our code depends on Huggingface transformers and Pytorch lightning, so theoretically we could do it over that whole intersection.


"""
def train_llama(config):
