...
def download_dataset():
    ...
    lost cause, due to Python internals bugging git annex version for datalad. wrote a bash script instead, use that.
    left here for now, will clean up before PR
